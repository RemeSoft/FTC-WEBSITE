    ...
    <section class="hero">
        <div class="center__container">
            <div class="hero__content">
                ...
                <a class="hero__button" href="./contact.html">Contact Us <i class="fa-solid fa-arrow-right"></i></a>

                <div class="hero__links">
                    <a class="hero:link__icon" href=""><i class="fa-brands fa-facebook-f"></i></a>
        ...
        <div class="center__container">
            ...
            <div class="country:card__holder">
                <div class="country:card">
                    <a class="country:card__link" href="./study_in_uk.html">
                ...
                <div class="country:card">
                    <a class="country:card__link" href="./study_in_usa.html">
                        <div class="country:card__flag">
                ...
                <div class="country:card">
                    <a class="country:card__link" href="./">
                        <div class="country:card__flag">
                ...
                <div class="country:card">
                    <a class="country:card__link" href="./study_in_australia.html">
                        <div class="country:card__flag">
                ...
                <div class="country:card">
                    <a class="country:card__link" href="./study_abord.html">
                        <div class="country:card__flag">
